...
public class DeliveryService {
    ...
    static private void accquireSlot(HttpExchange t) throws IOException {
        ...
        try {
            ...
            sql = "update slot set order_id = " + orderId + ", status_id = " + SLOT_HOLDED + " where id = " + slotId;
    ...
    static private void commitDelivery(HttpExchange t) throws IOException {
        ...
        try {
            ...
            String sql = "select order_id from slots where id = " + slotId + " and status_id = " + SLOT_STATUS_AVAIALBALE + " and order_id = " + SLOT_HOLDED + " for update";
            ...
            stmt=connection.createStatement();
            sql = "update slot set status_id = " + SLOT_USED + " where id = " + slotId;
